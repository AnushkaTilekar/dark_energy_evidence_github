...
pip install dark_energy_evidence_package
...
| Your Goal | Recommended Installation Method |
|-----------|---------------------------------|
| Just use the package| Option-(1) |
| Edit the source code | Option-(2) |
| Modify and contribute to the development of the package | Option-(2) |
...
If you use this "dark_energy_evidence_package" Python package in your research, teaching, or other academic  or non-academic work, please cite it as:
...
- Added instructions for installtion from PyPI (along with Github) for convenience of different users.
